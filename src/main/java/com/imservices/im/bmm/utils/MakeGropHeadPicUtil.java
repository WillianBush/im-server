...
@Slf4j
public final class MakeGropHeadPicUtil {
     ...
     * 画板尺寸
     */
    private static final int CANVANS_W = 150;
    private static final int CANVANS_H = 150;
...
//     * @param groupId 群编号
     ...
     * @throws IOException
     */
    public static String getCombinationOfhead(List<String> paths, String dir, String fn)
            throws IOException {
        ...
        for (int i = 0; i < paths.size(); i++) {
            BufferedImage resize2 = MakeGropHeadPicUtil.resize2(paths.get(i), imageSize, imageSize, true);
...
//
        ...
        FileInputStream fileInputStream = new FileInputStream(String.valueOf(outImage));
        ...
        try {
            ...
            ImageIO.write(outImage, format, imageOutputStream);
        } catch (Exception e) {
            log.error("系统生成群组头像图片转换失败" + e);
        }
   ...
   /**
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 1; i < 10; i++) {
            ...
            for (int j = 0; j < i; j++) {
                //本地图片路径或者网络图片路径
                list.add("D:/AlBrowserDownloads/defaultHeadPic.jpg");
            }
            File file = new File("");
            //生成目录
            String path ="d:/";
            groupId++;
            MakeGropHeadPicUtil.getCombinationOfhead(list, path, groupId+".jpg");
        }
    }
}   
