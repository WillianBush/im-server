...
public abstract class UpdateGroupLogoUtil {
    ...
    public static BufferedImage resize(String filePath, int height, int width, boolean bb) {
        try {
           ...
           // return (BufferedImage) itemp;
            return convertToBufferedImage(itemp);
        } catch (IOException e) {
            e.printStackTrace();
        }
        return null;
    ...
    public static void main(String[] args) throws Exception {
        ...
        String pic = "d:\\";
        picUrls.add(pic + "r1.png");
        picUrls.add(pic + "r2.png");
        picUrls.add(pic + "r3.png");
        picUrls.add(pic + "r4.png");
        picUrls.add(pic + "r5.png");
        picUrls.add(pic + "r6.png");
...
//        picUrls.add(pic + "9.jpg");
        ...
        UpdateGroupLogoUtil.generate(picUrls, "d:\\r7.png");
    }
