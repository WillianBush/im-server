package com.imservices.im.bmm.service.push;

public interface UniPushService {
	/***
	void test();
	
	IPushResult singlePush(AppPush ap, PushMessage pm, Integer isAlias);// 单个用户推送信息
	IAliasResult bindAlias(String alias, String clientId);// 别名绑定
	IAliasResult unBindAliasAll(String alias);// 别名解除绑定
